...
const Intro = () => {
    return (
        <div id="intro" className="w-full max-w-7xl mx-auto px-4 py-10">
            <div className="md:w-full w-full md:pl-10">
                <h2 className="text-5xl font-bold mb-4 text-gray-800">Intro</h2>
                ...
                <video controls className="w-full rounded-lg shadow-lg" src="/video/hero.mp4"/>
                <img
                    src="/img/ada.svg"
                    alt="placeholder"
